...
import { type SendEmailContactSchema } from "../schemas/mediaSchema";
...
export const contactEmailHtml = (input: SendEmailContactSchema) => {
  return `
    <body>
      <p>You have a new contact email from ${input.name}</p>
